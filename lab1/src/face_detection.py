...
def get_statistics_one_image(lookup_table, img, img_info, bias, roi_c_i,
        roi_c_j, roi_w, roi_h, n_quantification,bool_f):
    roi = region_of_interest(roi_c_i,roi_c_j,roi_w,roi_h, bool_f)
