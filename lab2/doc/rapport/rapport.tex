...
\section{Analyse quantitative}
    ...
    \subsection{Analyse des paramètres}
        ...
        \subsubsection{Recherche des meilleurs paramètres moyens}
        ...
        \subsubsection{Recherche de paramètres en fonction de l'application}
...
%	\end{figure}
    ...
    \subsection{Annexes: B}
    \label{annexes_b}
%	\begin{figure}[H]
%	    \begin{center}
%		\includegraphics[scale = 0.4]{images/courbes/folder_01_minN_3_fine_scale.png}
%		\caption{courbe Précision-Rappel: minNeighbours: 3, dossier: 1}
%		\label{fig:minN_3_fine_scale}
%	    \end{center}
%	\end{figure}
%
%	\begin{figure}[H]
%	    \begin{center}
%		\includegraphics[scale = 0.4]{images/courbes/folder_01_minN_4_fine_scale.png}
%		\caption{courbe Précision-Rappel: minNeighbours: 4, dossier: 1}
%		\label{fig:minN_4_fine_scale}
%	    \end{center}
%	\end{figure}
%
%	\begin{figure}[H]
%	    \begin{center}
%		\includegraphics[scale = 0.4]{images/courbes/folder_01_minN_5_fine_scale.png}
%		\caption{courbe Précision-Rappel: minNeighbours: 5, dossier: 1}
%		\label{fig:minN_5_fine_scale}
%	    \end{center}
%	\end{figure}
%
%	\begin{figure}[H]
%	    \begin{center}
%		\includegraphics[scale = 0.4]{images/courbes/folder_01_minN_6_fine_scale.png}
%		\caption{courbe Précision-Rappel: minNeighbours: 6, dossier: 1}
%		\label{fig:minN_6_fine_scale}
%	    \end{center}
%	\end{figure}
