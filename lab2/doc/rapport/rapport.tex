...
\section{Analyse quantitative}
    ...
    \subsection{Choix de l'évaluation}
        ...
        Dans notre cas, les vrais négatifs sont tous les fenêtres et sous-fenêtres qui ont été rejetées par la cascade de features.
        Le but de ce TP étant d'examiner un détecteur de visages en tant que boîte noire, nous avons décidé de ne pas modifier le code source pour avoir accès au nombre de fenêtres rejetées.
        ...
        \\
        La construction des courbes Précision-Rappel nécessite la classification des détections obtenues par la fonction \verb!detectMultiScale! d'{\it OpenCV} et l'affection de chaque détection par un score qui nous permettra de décider pour une détection donnée si l'on accepte ou pas. La construction va être décrite plus en détail dans la section  \ref{construction_courbe}.
    ...
    \subsection{Classification des détections}
        ...
        Les sommets de ce graphe sont divisé en deux ensembles, l'ensemble des détections et l'ensemble des étiquettes, i.e. des vrais visages, annotés dans la base de données.
        ...
        Un exemple d'illustration se trouve dans la figure \ref{fig:false_positive_couplage}, où le faux positif est déssiné en jaune, les vrais positifs en bleu et les étiquettes en rouge.
	    \begin{figure}[H]
	        \begin{center}
    ...
    \label{construction_courbe}
        ...
        Ce point correspond au cas où il n'y a plus de faux négatifs, i.e. le système de détection nous renvoie toutes les détections possibles.
    ...
    \subsection{Analyse des résultats}
        ...
        Pour le construire, nous avons parcourus le premier dossier de la base de données FDDB pour différents facteurs d'échelle et un nombre de voisins minimums fixé.
	...
	\end{figure}
        ...
        \\
        Premièrement, nous remarquons que l'AUC est nettement meilleur pour des facteurs d'échelle entre $1.05$ et $1.35$ que pour le reste des valeurs.
