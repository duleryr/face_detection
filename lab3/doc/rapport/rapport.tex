...
\subsection{Construction du réseau de neurones}
    ...
    \begin{itemize}
        \item
            ...
            Ce comportement a été montré dans les travaux de Zeiler et al. [2].
    ...
    Étant donné qu'il s'agit de notre première expérience construction de réseaux de neurones, nous nous sommes fortement inspirés d'un réseau d'un projet \textit{GitHub} existant, accomplissant la même tâche avec approximativement la même taille de données d'entrée.
